function simu_desc = main_solution_queue_fct_no_purging(parameters,saved,draw,verbose)
...
%             end
            ...
            m1=Omega_forward*K*m1_est(linear_idx)';
            r_comp_scaled_est = 1./(m1*lambda_J_job);
            m2 = Omega_forward^2*K^2*m2_est(linear_idx)';
